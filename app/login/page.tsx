          ...
          >
            <div className="flex flex-col gap-4">
              ...
              <button
                ...
                disabled={loading}
                className="flex w-full items-center justify-center gap-3 rounded-xl border border-[#d9d9e3] bg-white py-3 font-sans text-sm font-medium text-[#1f1f1f] transition-all hover:bg-[#f7f7fb] active:scale-[0.99] disabled:cursor-not-allowed disabled:opacity-60"
              >
                <svg
                ...
                >
                  <path
                    fill="#FFC107"
                    d="M43.611 20.083H42V20H24v8h11.303C33.654 32.657 29.24 36 24 36c-6.627 0-12-5.373-12-12s5.373-12 12-12c3.059 0 5.842 1.154 7.961 3.039l5.657-5.657C34.046 6.053 29.277 4 24 4 12.955 4 4 12.955 4 24s8.955 20 20 20 20-8.955 20-20c0-1.341-.138-2.65-.389-3.917z"
                  />
                  <path
                    fill="#FF3D00"
                  ...
                  <path
                    fill="#4CAF50"
                    d="M24 44c5.176 0 9.86-1.977 13.409-5.192l-6.19-5.238C29.141 35.091 26.715 36 24 36c-5.219 0-9.619-3.317-11.283-7.946l-6.522 5.025C9.505 39.556 16.227 44 24 44z"
                  />
                  <path
                    fill="#1976D2"
              ...
              <div className="flex items-center gap-3">
                ...
                <span className="font-mono text-[10px] text-[#a99abb] uppercase tracking-[0.2em]">
                  or
                </span>
                <div className="h-px flex-1 bg-[#4b376f]" />
              </div>
